...
export default function NetflixMovieDetails() {
  ...
  useEffect(() => {
    getNetflixMovieDetails(id).then(data => {
    ...
    <>
      <div className="details_container">
        ...
        <div className="movie_information">
          <h1>
            Movie Title: <span>{currentMovie.original_title}</span>{" "}
          </h1>
          <h2>
          ...
          <h2>
            Rating: <span>{currentMovie.vote_average}/10</span>
          </h2>
          <h2>
            Runtime: <span>{currentMovie.runtime} min.</span>
          </h2>
          <h2>
